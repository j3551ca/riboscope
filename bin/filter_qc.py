...
if __name__ == '__main__':
    ...
    parser.add_argument("--min_depth", type=int, required=True, help="Minimum threshold for average depth")
    parser.add_argument("--min_map_pair", type=int, required=True, help="Minimum threshold for number of reads that are mapped and paired")
    parser.add_argument("--min_map", type=int, required=True, help="Minimum threshold for number of mapped reads")
    parser.add_argument("--min_pct_map", type=float, required=True, help="Minimum threshold for percentage of mapped reads")
    parser.add_argument("--min_mq", type=int, required=True, help="Minimum threshold for average mapping quality")
    parser.add_argument("--min_10x", type=float, required=True, help="Minimum threshold for proportion of genome covered over 10X")
    parser.add_argument("--min_50x", type=float, required=True, help="Minimum threshold for proportion of genome covered over 50X")
    parser.add_argument("--max_secondary", type=int, required=True, help="Maximum allowable number of secondary alignments")
